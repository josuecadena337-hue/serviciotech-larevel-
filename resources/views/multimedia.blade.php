...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .video-thumb { background: #0f172a; height: 180px; display: flex; align-items: center; justify-content: center; position: relative; cursor: pointer; }
        .play-btn { width: 52px; height: 52px; background: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; box-shadow: 0 4px 16px rgba(0,0,0,0.3); transition: transform 0.2s; }
...
<div class="page-content">
    ...
    <div class="media-grid">
        ...
        <div class="media-card" data-tipo="nevera">
            ...
            <div class="card-body">
                <div class="card-tags">
                    <span class="tag-cat">Neveras</span>
                    <span class="tag-type">VIDEO</span>
                </div>
        ...
        <div class="media-card" data-tipo="lavadora">
            ...
            <div class="card-body">
                <div class="card-tags">
                    <span class="tag-cat">Lavadoras</span>
                    <span class="tag-type">VIDEO</span>
                </div>
        ...
        <div class="media-card" data-tipo="aire">
            ...
            <div class="card-body">
                <div class="card-tags">
                    <span class="tag-cat">Aires Acondicionados</span>
                    <span class="tag-type">VIDEO</span>
                </div>
        ...
        <div class="media-card" data-tipo="lavadora">
            ...
            <div class="card-body">
                <div class="card-tags">
                    <span class="tag-cat">Lavadoras</span>
                    <span class="tag-type">CONSEJO</span>
                </div>
        ...
        <div class="media-card" data-tipo="estufa">
            ...
            <div class="card-body">
                <div class="card-tags">
                    <span class="tag-cat">Estufas</span>
                    <span class="tag-type">VIDEO</span>
                </div>
        ...
        <div class="media-card" data-tipo="microondas">
            ...
            <div class="card-body">
                <div class="card-tags">
                    <span class="tag-cat">Microondas</span>
                    <span class="tag-type">VIDEO</span>
                </div>
