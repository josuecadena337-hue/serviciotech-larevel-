...
<div class="page-content">
    ...
    <div class="media-grid">
        ...
        <div class="media-card" data-tipo="nevera">
            ...
            <div class="card-body">
                <div class="card-tags"><span class="tag-cat">Neveras</span><span class="tag-type">https://youtu.be/UhO1Enj5vCU?si=6tm44544DNIas-PC</span></div>
                ...
                <button class="card-link" onclick="abrirVideo('https://youtu.be/UhO1Enj5vCU?si=6tm44544DNIas-PC')">Ver video →</button>
            </div>
        </div>
